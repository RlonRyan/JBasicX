...
public class JMenuXDeprecated {
    ...
    public JMenuXDeprecated(int width, int height, int x, int y, String... elements) {
    ...
    public JMenuXDeprecated(Point dimensions, Point position, String[] elements) {
